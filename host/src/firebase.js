// Firebase initialisation — shared singleton across all MFEs.
// getApps() prevents "already initialized" errors in hot-reload and
// when multiple MFEs reference the same firebase package via MF sharing.
